    ...
    <div className="bg-blue-100 min-h-screen relative overflow-hidden">
      ...
      <section className={`text-center py-16 px-4 relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <p className="text-lg md:text-xl mb-6 text-gray-700">
          Optimized Hosting for WordPress, Joomla, Drupal & More
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className={`flex justify-center mb-12 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="relative inline-flex border border-blue-500 rounded-full overflow-hidden shadow-2xl bg-white">
            ...
            <button onClick={toggleBilling} className={`relative px-8 py-3 text-sm font-medium transition-all duration-300 z-10 ${billing === 'monthly' ? 'text-white' : 'text-gray-700 hover:text-gray-900'}`}>
              Monthly
            </button>
            <button onClick={toggleBilling} className={`relative px-8 py-3 text-sm font-medium transition-all duration-300 z-10 ${billing === 'yearly' ? 'text-white' : 'text-gray-700 hover:text-gray-900'}`}>
              Yearly
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-16">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              {/* Price */}
              <div className="text-5xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r mb-8 from-blue-400 to-blue-600">
                {plan.price[billing]}
        ...
        <section className={`py-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-8">Why Choose Our CMS Hosting?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <CheckCircle className="mx-auto text-blue-600 w-10 h-10 mb-2" />
                <p className="font-medium">1-Click CMS Installation</p>
              </div>
              <div>
                <CheckCircle className="mx-auto text-blue-600 w-10 h-10 mb-2" />
              ...
              <div>
                <CheckCircle className="mx-auto text-blue-600 w-10 h-10 mb-2" />
                <p className="font-medium">Free SSL & CDN</p>
              </div>
              <div>
                <CheckCircle className="mx-auto text-blue-600 w-10 h-10 mb-2" />
                <p className="font-medium">24/7 CMS Support</p>
              </div>
            </div>
          </div>
        </section>
